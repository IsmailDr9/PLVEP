...
@section('content')
    ...
    <div class="card">
        ...
        <div class="box">
            ...
            <div class="box-body">
                {!! Form::open(['route' => 'manufacturers.store', 'method' => 'post', 'files'=>true]) !!}
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <input type="text" name="name_ar" value="{{old('name_ar')}}" class="form-control" placeholder="Enter Manufacturer name ar">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <input type="text" name="name_en" value="{{old('name_en')}}" class="form-control" placeholder="Enter Manufacturer name en">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <input type="text" name="facebook" value="{{old('facebook')}}" class="form-control" placeholder="Enter Manufacturer facebook">
                        </div>
                    </div>
                </div>
                <div class="row">
