                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <input type="text" name="state_name_ar" value="{{old('state_name_ar')}}" class="form-control" placeholder="Enter city name ar">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <input type="text" name="state_name_en" value="{{old('state_name_en')}}" class="form-control" placeholder="Enter city name en">
                        </div>
                    </div>
                </div>
                <div class="row">
